...
(function($, window, document, undefined){
  ...
  OnepageScroll.prototype.init = function() {
    ...
    if (settings.keyboard) {
      $(document).keydown(function(e) {
        ...
        switch(e.which) {
        case 38:
          if (tag !== 'input' && tag !== 'textarea') _this.move('up')
          break;
        case 40:
          if (tag !== 'input' && tag !== 'textarea') _this.move('down')
          break;
        default:
          return;
        }
  ...
  OnepageScroll.prototype.transformPage = function(index) {
    ...
    if (typeof settings.afterMove === 'function') {
      this.$el.one('webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend', function(e) {
